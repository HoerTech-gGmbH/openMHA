function [handle,dat] = G80_slider_cllb(src,event)
handle = guidata(src);
dat = handle.dat;
mha = handle.mha;
...
switch slider_tag
    case 'slider_l_250Hz'
        val = get(handle.G80_left_slider1,'value');
        val = round(val);
        delta = val - dat.g80.old(1);
        if isequal(get(handle.link,'tag'),'link')
            set(handle.G80_left_slider1,'value',val);
            set(handle.G80_left_edit1,'string',[num2str(val) ' dB']);
    ...
    case 'slider_l_500Hz'
        val = get(handle.G80_left_slider2,'value');
        val = round(val);
        delta = val - dat.g80.old(2);
        if isequal(get(handle.link,'tag'),'link')
            set(handle.G80_left_slider2,'value',val);
            set(handle.G80_left_edit2,'string',[num2str(val) ' dB']);
            ...
            dat.g80.old(7) = val2;
            mha_set(mha,'mha.transducers.mhachain.signal_processing.ola.c.mbc.multibandcompressor.dc_simple.g80',...
                [G80(1) val G80(3) G80(4) G80(5) G80(6) val2 G80(8) G80(9) G80(10)]);
    ...
    case 'slider_l_1kHz'
        val = get(handle.G80_left_slider3,'value');
        val = round(val);
        delta = val - dat.g80.old(3);
        if isequal(get(handle.link,'tag'),'link')
            set(handle.G80_left_slider3,'value',val);
            set(handle.G80_left_edit3,'string',[num2str(val) ' dB']);
    ...
    case 'slider_l_2kHz'
        val = get(handle.G80_left_slider4,'value');
        val = round(val);
        delta = val - dat.g80.old(4);
        if isequal(get(handle.link,'tag'),'link')
            set(handle.G80_left_slider4,'value',val);
            set(handle.G80_left_edit4,'string',[num2str(val) ' dB']);
    ...
    case 'slider_l_4kHz'
        val = get(handle.G80_left_slider5,'value');
        val = round(val);
        delta = val - dat.g80.old(5);
        if isequal(get(handle.link,'tag'),'link')
            set(handle.G80_left_slider5,'value',val);
            set(handle.G80_left_edit5,'string',[num2str(val) ' dB']);
            ...
            dat.g80.old(10) = val2;
            mha_set(mha,'mha.transducers.mhachain.signal_processing.ola.c.mbc.multibandcompressor.dc_simple.g80',...
                [G80(1) G80(2) G80(3) G80(4) val G80(6) G80(7) G80(8) G80(9) val2]);
    ...
    case 'slider_r_250Hz'
        val = get(handle.G80_right_slider1,'value');
        val = round(val);
        delta = val - dat.g80.old(6);
        if isequal(get(handle.link,'tag'),'link')
            set(handle.G80_right_slider1,'value',val);
            set(handle.G80_right_edit1,'string',[num2str(val) ' dB']);
    ...
    case 'slider_r_500Hz'
        val = get(handle.G80_right_slider2,'value');
        val = round(val);
        delta = val - dat.g80.old(7);
        if isequal(get(handle.link,'tag'),'link')
            set(handle.G80_right_slider2,'value',val);
            set(handle.G80_right_edit2,'string',[num2str(val) ' dB']);
    ...
    case 'slider_r_1kHz'
        val = get(handle.G80_right_slider3,'value');
        val = round(val);
        delta = val - dat.g80.old(8);
        if isequal(get(handle.link,'tag'),'link')
            set(handle.G80_right_slider3,'value',val);
            set(handle.G80_right_edit3,'string',[num2str(val) ' dB']);
    ...
    case 'slider_r_2kHz'
        val = get(handle.G80_right_slider4,'value');
        val = round(val);
        delta = val - dat.g80.old(9);
        if isequal(get(handle.link,'tag'),'link')
            set(handle.G80_right_slider4,'value',val);
            set(handle.G80_right_edit4,'string',[num2str(val) ' dB']);
            ...
            dat.g80.old(4) = val2;
            mha_set(mha,'mha.transducers.mhachain.signal_processing.ola.c.mbc.multibandcompressor.dc_simple.g80',...
                [G80(1) G80(2) G80(3) val2 G80(5) G80(6) G80(7) G80(9) val G80(10)]);
            ...
            set(handle.G80_right_edit4,'string',[num2str(val) ' dB']);
            mha_set(mha,'mha.transducers.mhachain.signal_processing.ola.c.mbc.multibandcompressor.dc_simple.g80',...
                [G80(1) G80(2) G80(3) G80(4) G80(5) G80(6) G80(7) G80(9) val G80(10)]);
            set(handle.right_CR4,'string',num2str(round((80-50)/(val+80-(G50(9)+50)),2)));
        end
    ...
    case 'slider_r_4kHz'
        val = get(handle.G80_right_slider5,'value');
        val = round(val);
        delta = val - dat.g80.old(10);
        if isequal(get(handle.link,'tag'),'link')
            set(handle.G80_right_slider5,'value',val);
            set(handle.G80_right_edit5,'string',[num2str(val) ' dB']);
    ...
    case 'all_right'
        val = get(handle.G80_all_slider_right,'value');
        val = round(val);
        if isequal(get(handle.link,'tag'),'link')
            set(handle.G80_all_slider_right,'value',val);
%             set(handle.G80_all_edit_right,'string',[num2str(val) ' dB']);
            set(handle.G80_all_slider_left,'value',val);
%             set(handle.G80_all_edit_left,'string',[num2str(val) ' dB']);

            if dat.g80.ref_right(1) + val > get(handle.G80_right_slider1,'max')
                set(handle.G80_right_edit1,'string',[num2str(get(handle.G80_right_slider1,'max')) ' dB']);
                set(handle.G80_right_slider1,'value',get(handle.G80_right_slider1,'max'));
                G80_6 = get(handle.G80_right_slider1,'max');
            elseif dat.g80.ref_right(1) + val < get(handle.G80_right_slider1,'min')
                set(handle.G80_right_edit1,'string',[num2str(get(handle.G80_right_slider1,'min')) ' dB']);
                set(handle.G80_right_slider1,'value',get(handle.G80_right_slider1,'min'));
                G80_6 = get(handle.G80_right_slider1,'min');
            else 
                set(handle.G80_right_slider1,'value',dat.g80.ref_right(1) + val);
                set(handle.G80_right_edit1,'string',[num2str(dat.g80.ref_right(1) + val) ' dB']);
                G80_6 = dat.g80.ref_right(1) + val;
            end
            if dat.g80.ref_right(2) + val > get(handle.G80_right_slider2,'max')
                set(handle.G80_right_edit2,'string',[num2str(get(handle.G80_right_slider2,'max')) ' dB']);
                set(handle.G80_right_slider2,'value',get(handle.G80_right_slider2,'max'));
                G80_7 = get(handle.G80_right_slider2,'max');
            elseif dat.g80.ref_right(2) + val < get(handle.G80_right_slider2,'min')
                set(handle.G80_right_edit2,'string',[num2str(get(handle.G80_right_slider2,'min')) ' dB']);
                set(handle.G80_right_slider1,'value',get(handle.G80_right_slider2,'min'));
                G80_7 = get(handle.G80_right_slider2,'min');
            else 
                set(handle.G80_right_slider2,'value',dat.g80.ref_right(2) + val);
                set(handle.G80_right_edit2,'string',[num2str(dat.g80.ref_right(2) + val) ' dB']);
                G80_7 = dat.g80.ref_right(2) + val;
            end
            if dat.g80.ref_right(3) + val > get(handle.G80_right_slider3,'max')
                set(handle.G80_right_edit3,'string',[num2str(get(handle.G80_right_slider3,'max')) ' dB']);
                set(handle.G80_right_slider3,'value',get(handle.G80_right_slider3,'max'));
                G80_8 = get(handle.G80_right_slider3,'max');
            elseif dat.g80.ref_right(3) + val < get(handle.G80_right_slider3,'min')
                set(handle.G80_right_edit3,'string',[num2str(get(handle.G80_right_slider3,'min')) ' dB']);
                set(handle.G80_right_slider3,'value',get(handle.G80_right_slider3,'min'));
                G80_8 = get(handle.G80_right_slider3,'min');
            else 
                set(handle.G80_right_slider3,'value',dat.g80.ref_right(3) + val);
                set(handle.G80_right_edit3,'string',[num2str(dat.g80.ref_right(3) + val) ' dB']);
                G80_8 = dat.g80.ref_right(3) + val;
            end
            if dat.g80.ref_right(4) + val > get(handle.G80_right_slider4,'max')
                set(handle.G80_right_edit4,'string',[num2str(get(handle.G80_right_slider4,'max')) ' dB']);
                set(handle.G80_right_slider4,'value',get(handle.G80_right_slider4,'max'));
                G80_9 = get(handle.G80_right_slider4,'max');
            elseif dat.g80.ref_right(4) + val < get(handle.G80_right_slider4,'min')
                set(handle.G80_right_edit4,'string',[num2str(get(handle.G80_right_slider4,'min')) ' dB']);
                set(handle.G80_right_slider4,'value',get(handle.G80_right_slider4,'min'));
                G80_9 = get(handle.G80_right_slider4,'min');
            else 
                set(handle.G80_right_slider4,'value',dat.g80.ref_right(4) + val);
                set(handle.G80_right_edit4,'string',[num2str(dat.g80.ref_right(4) + val) ' dB']);
                G80_9 = dat.g80.ref_right(4) + val;
            end
            if dat.g80.ref_right(5) + val > get(handle.G80_right_slider5,'max')
                set(handle.G80_right_edit5,'string',[num2str(get(handle.G80_right_slider5,'max')) ' dB']);
                set(handle.G80_right_slider5,'value',get(handle.G80_right_slider5,'max'));
                G80_10 = get(handle.G80_right_slider5,'max');
            elseif dat.g80.ref_right(5) + val < get(handle.G80_right_slider5,'min')
                set(handle.G80_right_edit5,'string',[num2str(get(handle.G80_right_slider5,'min')) ' dB']);
                set(handle.G80_right_slider5,'value',get(handle.G80_right_slider5,'min'));
                G80_10 = get(handle.G80_right_slider5,'min');
            else 
                set(handle.G80_right_slider5,'value',dat.g80.ref_right(5) + val);
                set(handle.G80_right_edit5,'string',[num2str(dat.g80.ref_right(5) + val) ' dB']);
                G80_10 = dat.g80.ref_right(5) + val;
            end
            
            
            if dat.g80.ref_left(1) + val > get(handle.G80_left_slider1,'max')
                set(handle.G80_left_edit1,'string',[num2str(get(handle.G80_left_slider1,'max')) ' dB']);
                set(handle.G80_left_slider1,'value',get(handle.G80_left_slider1,'max'));
                G80_1 = get(handle.G80_left_slider1,'max');
            elseif dat.g80.ref_left(1) + val < get(handle.G80_left_slider1,'min')
                set(handle.G80_left_edit1,'string',[num2str(get(handle.G80_left_slider1,'min')) ' dB']);
                set(handle.G80_left_slider1,'value',get(handle.G80_left_slider1,'min'));
                G80_1 = get(handle.G80_left_slider1,'min');
            else 
                set(handle.G80_left_slider1,'value',dat.g80.ref_left(1) + val);
                set(handle.G80_left_edit1,'string',[num2str(dat.g80.ref_left(1) + val) ' dB']);
                G80_1 = dat.g80.ref_left(1) + val;
            end
            if dat.g80.ref_left(2) + val > get(handle.G80_left_slider2,'max')
                set(handle.G80_left_edit2,'string',[num2str(get(handle.G80_left_slider2,'max')) ' dB']);
                set(handle.G80_left_slider2,'value',get(handle.G80_left_slider2,'max'));
                G80_2 = get(handle.G80_left_slider2,'max');
            elseif dat.g80.ref_left(2) + val < get(handle.G80_left_slider2,'min')
                set(handle.G80_left_edit2,'string',[num2str(get(handle.G80_left_slider2,'min')) ' dB']);
                set(handle.G80_left_slider2,'value',get(handle.G80_left_slider2,'min'));
                G80_2 = get(handle.G80_left_slider2,'min');
            else 
                set(handle.G80_left_slider2,'value',dat.g80.ref_left(2) + val);
                set(handle.G80_left_edit2,'string',[num2str(dat.g80.ref_left(2) + val) ' dB']);
                G80_2 = dat.g80.ref_left(2) + val;
            end
            if dat.g80.ref_left(3) + val > get(handle.G80_left_slider3,'max')
                set(handle.G80_left_edit3,'string',[num2str(get(handle.G80_left_slider3,'max')) ' dB']);
                set(handle.G80_left_slider3,'value',get(handle.G80_left_slider3,'max'));
                G80_3 = get(handle.G80_left_slider3,'max');
            elseif dat.g80.ref_left(3) + val < get(handle.G80_left_slider3,'min')
                set(handle.G80_left_edit3,'string',[num2str(get(handle.G80_left_slider3,'min')) ' dB']);
                set(handle.G80_left_slider3,'value',get(handle.G80_left_slider3,'min'));
                G80_3 = get(handle.G80_left_slider3,'min');
            else 
                set(handle.G80_left_slider3,'value',dat.g80.ref_left(3) + val);
                set(handle.G80_left_edit3,'string',[num2str(dat.g80.ref_left(3) + val) ' dB']);
                G80_3 = dat.g80.ref_left(3) + val;
            end
            if dat.g80.ref_left(4) + val > get(handle.G50_left_slider4,'max')
                set(handle.G80_left_edit4,'string',[num2str(get(handle.G50_left_slider4,'max')) ' dB']);
                set(handle.G50_left_slider4,'value',get(handle.G50_left_slider4,'max'));
                G80_4 = get(handle.G50_left_slider4,'max');
            elseif dat.g80.ref_left(4) + val < get(handle.G50_left_slider4,'min')
                set(handle.G80_left_edit4,'string',[num2str(get(handle.G50_left_slider4,'min')) ' dB']);
                set(handle.G50_left_slider4,'value',get(handle.G50_left_slider4,'min'));
                G80_4 = get(handle.G50_left_slider4,'min');
            else 
                set(handle.G50_left_slider4,'value',dat.g80.ref_left(4) + val);
                set(handle.G80_left_edit4,'string',[num2str(dat.g80.ref_left(4) + val) ' dB']);
                G80_4 = dat.g80.ref_left(4) + val;
            end
            if dat.g80.ref_left(5) + val > get(handle.G50_left_slider5,'max')
                set(handle.G80_left_edit5,'string',[num2str(get(handle.G50_left_slider5,'max')) ' dB']);
                set(handle.G50_left_slider5,'value',get(handle.G50_left_slider5,'max'));
                G80_5 = get(handle.G50_left_slider5,'max');
            elseif dat.g80.ref_left(5) + val < get(handle.G50_left_slider5,'min')
                set(handle.G80_left_edit5,'string',[num2str(get(handle.G50_left_slider5,'min')) ' dB']);
                set(handle.G50_left_slider5,'value',get(handle.G50_left_slider5,'min'));
                G80_5 = get(handle.G50_left_slider5,'min');
            else 
                set(handle.G50_left_slider5,'value',dat.g80.ref_left(5) + val);
                set(handle.G80_left_edit5,'string',[num2str(dat.g80.ref_left(5) + val) ' dB']);
                G80_5 = dat.g80.ref_left(5) + val;
            end
            mha_set(mha,'mha.transducers.mhachain.signal_processing.ola.c.mbc.multibandcompressor.dc_simple.g80',...
                [G80_1 G80_2 G80_3 G80_4 G80_5 G80_6 G80_7 G80_8 G80_9 G80_10]);
        
            set(handle.right_CR1,'string',num2str(round((80-50)/(handle.G80_right_slider1.Value+80-(G50(6)+50)),2)));
            set(handle.right_CR2,'string',num2str(round((80-50)/(handle.G80_right_slider2.Value+80-(G50(7)+50)),2)));
            set(handle.right_CR3,'string',num2str(round((80-50)/(handle.G80_right_slider3.Value+80-(G50(8)+50)),2)));
            set(handle.right_CR4,'string',num2str(round((80-50)/(handle.G80_right_slider4.Value+80-(G50(9)+50)),2)));
            set(handle.right_CR5,'string',num2str(round((80-50)/(handle.G80_right_slider5.Value+80-(G50(10)+50)),2)));
            
            set(handle.left_CR1,'string',num2str(round((80-50)/(handle.G80_left_slider1.Value+80-(G50(6)+50)),2)));
            set(handle.left_CR2,'string',num2str(round((80-50)/(handle.G80_left_slider2.Value+80-(G50(7)+50)),2)));
            set(handle.left_CR3,'string',num2str(round((80-50)/(handle.G80_left_slider3.Value+80-(G50(8)+50)),2)));
            set(handle.left_CR4,'string',num2str(round((80-50)/(handle.G80_left_slider4.Value+80-(G50(9)+50)),2)));
            set(handle.left_CR5,'string',num2str(round((80-50)/(handle.G80_left_slider5.Value+80-(G50(10)+50)),2)));
...
%             set(handle.G80_all_edit_right,'string',[num2str(val) ' dB']);
            ...
            mha_set(mha,'mha.transducers.mhachain.signal_processing.ola.c.mbc.multibandcompressor.dc_simple.g80',...
                [G80(1:5) G80_6 G80_7 G80_8 G80_9 G80_10]);
            set(handle.right_CR1,'string',num2str(round((80-50)/(handle.G80_right_slider1.Value+80-(G50(6)+50)),2)));
            set(handle.right_CR2,'string',num2str(round((80-50)/(handle.G80_right_slider2.Value+80-(G50(7)+50)),2)));
            set(handle.right_CR3,'string',num2str(round((80-50)/(handle.G80_right_slider3.Value+80-(G50(8)+50)),2)));
            set(handle.right_CR4,'string',num2str(round((80-50)/(handle.G80_right_slider4.Value+80-(G50(9)+50)),2)));
    ...
    case 'all_left'
        val = get(handle.G80_all_slider_left,'value');
        val = round(val);
        if isequal(get(handle.link,'tag'),'link')
            set(handle.G80_all_slider_right,'value',val);
%             set(handle.G80_all_edit_right,'string',[num2str(val) ' dB']);
...
%             set(handle.G80_all_edit_left,'string',[num2str(val) ' dB']);
            ...
            mha_set(mha,'mha.transducers.mhachain.signal_processing.ola.c.mbc.multibandcompressor.dc_simple.g80',...
                [G80_1 G80_2 G80_3 G80_4 G80_5 G80(6:10)]);
            set(handle.left_CR1,'string',num2str(round((80-50)/(handle.G80_left_slider1.Value+80-(G50(6)+50)),2)));
            set(handle.left_CR2,'string',num2str(round((80-50)/(handle.G80_left_slider2.Value+80-(G50(7)+50)),2)));
            set(handle.left_CR3,'string',num2str(round((80-50)/(handle.G80_left_slider3.Value+80-(G50(8)+50)),2)));
            set(handle.left_CR4,'string',num2str(round((80-50)/(handle.G80_left_slider4.Value+80-(G50(9)+50)),2)));
