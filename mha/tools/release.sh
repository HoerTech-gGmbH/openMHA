...
echo " 3) upload the openMHA_starting_guide to"
echo "    http://www.openmha.org/docs/openMHA_starting_guide.pdf by checking it"
echo "    into the gh-pages branch of the github openMHA repository, in ./docs/"
