...
doasvm_classification::doasvm_classification(algo_comm_t & ac,
    ...
    : MHAPlugin::plugin_t<doasvm_classification_config>("Foo Transform Plugin for Superfluous Spectra",ac)
 ...
 */
MHAPLUGIN_CALLBACKS(doasvm_classification,wave,wave)
...
MHAPLUGIN_DOCUMENTATION(
        "filter",
        "This plugin loads the parameters of a pre-trained SVM and computes the probabilitiesfoe a given range if directions about whether there is a source coming from each of those directions."
        )
