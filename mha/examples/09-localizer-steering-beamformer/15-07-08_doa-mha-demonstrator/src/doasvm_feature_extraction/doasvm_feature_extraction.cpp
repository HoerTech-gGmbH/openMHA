/*
 * This plugin computes the GCC-PHAT given the stereo time domain signal, which is forwarded to the next plugin in the chain unaltered.
 */
...
doasvm_feature_extraction::doasvm_feature_extraction(algo_comm_t & ac,
    ...
    : MHAPlugin::plugin_t<doasvm_feature_extraction_config>("Foo Transform Plugin for Superfluous Spectra",ac)
 ...
 */
MHAPLUGIN_CALLBACKS(doasvm_feature_extraction,wave,wave)
