...
% mha/examples/03-coherence-filter/coherence.cfg and check that the 
...
function test_runexample03()
  dir = '../examples/03-coherence-filter/';
  cfg = 'coherence.cfg';
  ...
  expected_levels = [-23.138  -21.963  -26.864  -25.894];
