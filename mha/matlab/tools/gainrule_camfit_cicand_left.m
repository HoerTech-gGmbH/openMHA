function sGt = gainrule_camfit_cicand_left(sAud, sCfg)
...
% This rule is modified to fit severe hearing losses, on left ear only.
  sAud = audprof2aud( sAud );
sGt = camfit_ci_candidate_unilateral(sAud, sCfg, 'l');
