...
disp([' UPLOAD - ',char(10),'',char(10),' Usage:',char(10),'  multifit = libmultifit();',char(10),'  sGt = multifit.upload( sFit, mha );',char(10),'']);
...
disp([' VALIDATE_FITS - ',char(10),'',char(10),' Usage:',char(10),'  multifit = libmultifit();',char(10),'  vValid = multifit.validate_fits( csFits, sFit, mha );',char(10),'']);
...
disp([' VERIFY - ',char(10),'',char(10),' Usage:',char(10),'  multifit = libmultifit();',char(10),'  sFit = multifit.verify( sFit, mha );',char(10),'']);
