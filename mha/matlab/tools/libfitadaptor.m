...
disp([' OHCCOMP_GT2MHA - ',char(10),'',char(10),' Usage:',char(10),'  fitadaptor = libfitadaptor();',char(10),'  sCfg = fitadaptor.OHCcomp_gt2mha( sGt, sMHACfg );',char(10),'']);
...
disp([' DC_SIMPLE_GT2MHA - ',char(10),'',char(10),' Usage:',char(10),'  fitadaptor = libfitadaptor();',char(10),'  sCfg = fitadaptor.dc_simple_gt2mha( sGt, sMHACfg );',char(10),'']);
...
function sCfg = fitadaptor_equalize_gt2mha( sGt, sMHACfg )
  ...
  sCfg.gains = [];
  for ch=sGt.side
    sCfg.gains = 10.^([sCfg.gains;sGt.(ch)(2,:)]/20);
  end


function help_equalize_gt2mha
disp([' EQUALIZE_GT2MHA - ',char(10),'',char(10),' Usage:',char(10),'  fitadaptor = libfitadaptor();',char(10),'  sCfg = fitadaptor.equalize_gt2mha( sGt, sMHACfg );',char(10),'']);
...
disp([' GAINTABLE_GT2MHA - ',char(10),'',char(10),' Usage:',char(10),'  fitadaptor = libfitadaptor();',char(10),'  sCfg = fitadaptor.gaintable_gt2mha( sGt, sMHACfg );',char(10),'']);
...
disp([' MDC_GT2MHA - ',char(10),'',char(10),' Usage:',char(10),'  fitadaptor = libfitadaptor();',char(10),'  sCfg = fitadaptor.mdc_gt2mha( sGt, sMHACfg );',char(10),'']);
...
disp([' OHC_COMP_GT2MHA - ',char(10),'',char(10),' Usage:',char(10),'  fitadaptor = libfitadaptor();',char(10),'  sCfg = fitadaptor.ohc_comp_gt2mha( sGt, sMHACfg );',char(10),'']);
...
disp([' OHC_COMP_SIMPLE_GT2MHA - ',char(10),'',char(10),' Usage:',char(10),'  fitadaptor = libfitadaptor();',char(10),'  sCfg = fitadaptor.ohc_comp_simple_gt2mha( sGt, sMHACfg );',char(10),'']);
...
disp([' OHC_EFFICIENT_GT2MHA - ',char(10),'',char(10),' Usage:',char(10),'  fitadaptor = libfitadaptor();',char(10),'  sCfg = fitadaptor.ohc_efficient_gt2mha( sGt, sMHACfg );',char(10),'']);
...
disp([' OHC_GT2MHA - ',char(10),'',char(10),' Usage:',char(10),'  fitadaptor = libfitadaptor();',char(10),'  sCfg = fitadaptor.ohc_gt2mha( sGt, sMHACfg );',char(10),'']);
...
disp([' OHCSIMPLE_GT2MHA - ',char(10),'',char(10),' Usage:',char(10),'  fitadaptor = libfitadaptor();',char(10),'  sCfg = fitadaptor.ohcsimple_gt2mha( sGt, sMHACfg );',char(10),'']);
...
disp([' SPSMFT_GT2MHA - ',char(10),'',char(10),' Usage:',char(10),'  fitadaptor = libfitadaptor();',char(10),'  sCfg = fitadaptor.spsmft_gt2mha( sGt, sMHACfg );',char(10),'']);
