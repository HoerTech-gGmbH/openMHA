function sGt = gainrule_NAL_NL1_biunilateral_deaf(sAud, sCfg)
...
crossOver = sCfg.edge_frequencies(2:(end-1));%nur obere Grenzfrequenzen für setBWC?
...
for side = 'lr'
    ...
    ACother = repmat(125, size(AC)); % Pretend the other ear is deaf.
    ...
    for channel = 1:channels
        ...
        for level_index = 1:nlevels
            ...
            insertion_gain = nl1mex('RealEarInsertionGain',...
                AC, BC, bblev, 2, channels, 0, 0, ACother, 0);
            ...
            if sum(usable_gain_indices) == 0 % avoid NaN intermediate result
                usable_gain_indices = covered_band_indices;
            end
