...
#ifndef CI_AURALIZATION_ACE_HH
#define CI_AURALIZATION_ACE_HH


#include "mha_plugin.hh"


class Ci_auralization_ace;
 ...
 * ACE (advanced combination encoder, n-of-m) coding strategy with 22 channels
 */
class Ci_auralization_ace_cfg
{
public:
    /**
     ...
     * @param electrodogram
     *   Electrodogram (contains a matrix with dimensions m x n, where
     *   m = total number of electrodes and n = number of active electrodes,
     *   and where the order of the n active electrodes corrrespondes to the
     *   temporal sequence of their activation)
     * @param n_electrodes
     *   Number of active electrodes
     * @param m_electrodes
     *   Total number of electrodes per side
     * @param Ci_auralization_ace
...
private:
    ...
    /**
     * Electrodogram (contains a matrix with dimensions m x n, where m = total
     * number of electrodes and n = number of active electrodes, and where the
 ...
 * specified AC variable, using a stimulation strategy similar to a typical ACE
 * (advanced combination encoder, n-of-m) coding strategy with 22 channels
 */
class Ci_auralization_ace : public MHAPlugin::plugin_t<Ci_auralization_ace_cfg>
{
public:
    /**
     ...
     */
    Ci_auralization_ace(algo_comm_t &ac,
