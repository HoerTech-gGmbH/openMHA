...
// Copyright © 2005 2006 2007 2009 2010 2011 2013 2014 2015 2016 2017 HörTech gGmbH
...
"\n"
"Please use the iFFT plugin {\\em spec2wave} (p. \\pageref{plug:spec2wave}) to get the\n"
"waveform signal of the filterbank output. The {\\em matrixmixer}\n"
"(p. \\pageref{plug:matrixmixer})\n"
"plugin or {\\em combinechannels} (p. \\pageref{plug:combinechannels}) can be used for resynthesis.\n"
"\n"
//"After the plugin was prepared, the following AC variables are\n"
//"available (the variable prefix {\\em fftfilterbank\\_} should be replaced\n"
//"by the configured plugin name):\n"
//"\n"
//"\\begin{description}\n"
//"\\mhavardesc{fftfilterbank\\_cf}{Center frequencies in Hz.}\n"
//"\\mhavardesc{fftfilterbank\\_ef}{Edge frequencies in Hz. In the center frequency mode, the smallest and highest edge frequency is the smallest or highest possible numeric value.}\n"
//"\\mhavardesc{fftfilterbank\\_nchannels}{Number of input channels. This field is needed for the {\\em combinechannels} plugin.}\n"
//"\\end{description}\n"
"\n"
...
"\\MHAfigure{Example filter shapes with center frequencies configured}{fftfb_shapes_center}\n"
"\\MHAfigure{Example filter shapes with edge frequencies configured}{fftfb_shapes_edge}\n"
    )
