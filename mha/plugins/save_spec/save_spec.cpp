...
(save_spec,
 ...
 "This plugin saves the spectral signal to an AC variable. The name of the variable is the same as the name of the plugin\n"
 "and can be changed by assigning an alias to the plugin with the usual plugin\\_name:alias\\_name syntax.")
