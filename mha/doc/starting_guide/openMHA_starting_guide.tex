...
%%% Copyright © 2021 2022 2024 2026 Hörzentrum Oldenburg gGmbH
%%%
...
\fancyfoot[RE]{\fancyplain{}{\bfseries\scriptsize \copyright{} 2005-2021 H\"orTech gGmbH, Oldenburg, \bfseries\scriptsize \copyright{} 2021-2026 H\"orzentrum Oldenburg gGmbH }}
\fancyfoot[LO]{\fancyplain{}{\bfseries\scriptsize \copyright{} 2005-2021 H\"orTech gGmbH, Oldenburg, \bfseries\scriptsize \copyright{} 2021-2026 H\"orzentrum Oldenburg gGmbH }}
...
module \emph{MHAIOFile} provides audio file access and \emph{MHAIOTCP}
provides TCP/IP-based signal exchange.
...
\item \large{{Operating System}}
  \begin{itemize}
  \item \textcolor{orange}{\textbf{Linux:}} Ubuntu 22.04 or later
  \item \textcolor{orange}{\textbf{Windows:}} Windows 11
  \item \textcolor{orange}{\textbf{macOS:}} macOS with Homebrew installed
  \end{itemize}

\item \large{{openMHA}}   \\
  \footnotesize{\url{https://github.com/HoerTech-gGmbH/openMHA/blob/master/INSTALLATION.md}}
\item \large{{either Octave plus OpenJDK, or Matlab}}
  \begin{itemize}
  \item \large{{Octave:}}
    \begin{itemize}
    \item \textcolor{orange}{\textbf{\large{Linux:}}} \\
      $\rightarrow$ {\ttfamily sudo apt install octave-signal default-jre-headless}
    \item \textcolor{orange}{\textbf{Windows:}} \\
      \footnotesize{Octave: \url{%
          https://www.gnu.org/software/octave/download.html}} \\
      \footnotesize{OpenJDK: e.g. "Temurin" from \url{%
          https://adoptium.net/}}
    \item \textcolor{orange}{\textbf{macOS:}} \\
      $\rightarrow$ Automatically installed as a recommended dependency
      when installing openMHA via Homebrew.
    \end{itemize}
  \item \large{{Matlab:}} \\
...
\item \large{{JACK Audio Connection Kit}}
  ...
  \item \textcolor{orange}{\textbf{macOS:}} \\
    $\rightarrow$
    Automatically installed as dependency when installing openMHA via Homebrew.
  \end{itemize}
\end{itemize}
...
\begin{itemize}
\item \textcolor{orange}{\textbf{Windows}} \\
  Repeat the installation process using the \textbf{Windows zip installer}
  for your system from the latest openMHA release on Github.
  The installation instructions can be found at
  \url{https://github.com/HoerTech-gGmbH/openMHA/blob/master/INSTALLATION.md}
\item \textcolor{orange}{\textbf{macOS}} \\
  Upgrade openMHA via Homebrew by executing the following commands in the terminal: \\
  {\ttfamily brew update} \\
  {\ttfamily brew upgrade} \\
  Please refer to the installation instructions which can be found at
  \url{https://github.com/HoerTech-gGmbH/openMHA/blob/master/INSTALLATION.md}
\item \textcolor{orange}{\textbf{Linux}} \\
  Repeat the installation process using the latest \textbf{Linux release files}
  for your system from the latest openMHA release on Github.
  The installation instructions can be found at
  \url{https://github.com/HoerTech-gGmbH/openMHA/blob/master/INSTALLATION.md}
\end{itemize}
...
\item \textcolor{orange}{\textbf{macOS with Intel processor}}: \textit{/usr/local/share/openmha/examples/00-gain} 
\item \textcolor{orange}{\textbf{macOS with ARM processor}}: \textit{/opt/homebrew/share/openmha/examples/00-gain}
\end{itemize}
...
\begin{enumerate}
    ...
    \begin{itemize}
\item \textcolor{orange}{\textbf{Linux}}: \\ Type {\ttfamily qjackctl} into a \textbf{terminal}. 
\item \textcolor{orange}{\textbf{Windows}}: \\ Use the \textbf{JACK Control} start menu entry.
\item \textcolor{orange}{\textbf{macOS}}: \\ Type {\ttfamily qjackctl} into a \textbf{terminal}. If asked, then you need to allow access to your sound devices.
\end{itemize}
...
\item \textcolor{orange}{\textbf{Linux:}} Set LD\_LIBRARY\_PATH to empty by typing \\ {\ttfamily
  ...
  \textcolor{orange}{\textbf{MacOS with Intel processor:}} Type: \\{\ttfamily $\rightarrow$ setenv(\textquotesingle PATH\textquotesingle, [getenv(\textquotesingle PATH\textquotesingle) \textquotesingle :/usr/local/bin\textquotesingle]);} \\
  into the \textbf{Command Window} \\  
  \textcolor{orange}{\textbf{MacOS with ARM processor:}} Type: \\{\ttfamily $\rightarrow$ setenv(\textquotesingle PATH\textquotesingle, [getenv(\textquotesingle PATH\textquotesingle) \textquotesingle :/opt/homebrew/bin\textquotesingle]);} \\
  into the \textbf{Command Window} \\  
...
\item \textcolor{orange}{\textbf{macOS with Intel processor}}: \\
  \textit{/usr/local/share/openmha/examples/05-frequency-shifting}
\item \textcolor{orange}{\textbf{macOS with ARM processor}}: \\
  \textit{/opt/homebrew/share/openmha/examples/05-frequency-shifting}
\end{itemize}
...
\item \textcolor{orange}{\textbf{macOS with Intel processor}}: \\ $\rightarrow$
  {\ttfamily addpath(\textquotesingle{}/usr/local/lib/openmha/mfiles/\textquotesingle{})}
\item \textcolor{orange}{\textbf{macOS with ARM processor}}: \\ $\rightarrow$
  {\ttfamily addpath(\textquotesingle{}/opt/homebrew/lib/openmha/mfiles/\textquotesingle{})}
\end{itemize}
...
\item \textcolor{orange}{\textbf{macOS with Intel processor}}: \textit{/usr/local/share/openmha/examples/01-dynamic-compression} 
\item \textcolor{orange}{\textbf{macOS with ARM processor}}: \textit{/opt/homebrew/share/openmha/examples/01-dynamic-compression} 
\end{itemize}
...
\item \textcolor{orange}{\textbf{macOS with Intel processor}}: {\ttfamily addpath(\textquotesingle{}/usr/local/lib/openmha/mfiles/\textquotesingle{})}
\item \textcolor{orange}{\textbf{macOS with ARM processor}}: {\ttfamily addpath(\textquotesingle{}/opt/homebrew/lib/openmha/mfiles/\textquotesingle{})}
\end{itemize}
...
\item The current gaintable {\ttfamily gtdata} and relevant parameters such as {\ttfamily gtmin} and {\ttfamily gtstep} (more information on these can be found under {\url{%
          {http://www.openmha.org/docs/openMHA_plugins.pdf#subsection.5.1}}}
...
\item \textcolor{orange}{\textbf{macOS with Intel processor}}: \textit{/usr/local/share/openmha/examples/15-ac-variables} 
\item \textcolor{orange}{\textbf{macOS with ARM processor}}: \textit{/opt/homebrew/share/openmha/examples/15-ac-variables}
\end{itemize}
...
\\(\footnotesize{\url{%
          {http://www.openmha.org/docs/openMHA_plugins.pdf#subsection.19.3}}}
