...
\item \large{{Operating System}}
  ...
  \item \textcolor{orange}{\textbf{macOS:}} macOS Monterey (version 12) or later
  \end{itemize}
...
\item \textcolor{orange}{\textbf{macOS}} \\
  When upgrading from openMHA 4.17.0 or earlier, you need to uninstall
  the old version first. When upgrading from openMHA 4.18.0 or leater, you can
  update via Homebrew: \\
  {\ttfamily brew update} \\
