...
Alternatively, you can start the \mhad{} outside \Matlab{} as described
in the previous sections for the liev-processing from your command line
and access the process from \Matlab.
%
How this is done is described in the following for both cases.
...
be in the \Matlab{} path and the mha javaclass has been added by executing
\begin{verbatim}
