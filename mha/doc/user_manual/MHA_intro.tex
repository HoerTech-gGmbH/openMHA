...
The HörTech Master Hearing Aid (MHA) is a software development
...
\figref{mha_structure_now}.

\MHAfigure[][0.7\linewidth]{Layered structure of the master hearing aid}{mha_structure_now}
...
\item A {\bf MHA Plugin} generally performs the
