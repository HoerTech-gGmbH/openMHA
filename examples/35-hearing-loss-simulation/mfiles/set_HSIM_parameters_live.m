...
function set_HSIM_parameters_live()
    ...
    % simulator (real-time processing of a stereo input signal)
    %
    ...
    %   Sample Rate:   <value of srate in HSIM_live.cfg>
    %   Frames/Period: <value of fragsize in HSIM_live.cfg>
    %
    ...
    % invoking "?read:cfg/HSIM_live.cfg" in interactive mode).
    %
    ...
    % are specified):
    sSmearingType = 'Custom';  % {'Automatic', 'Custom'}
