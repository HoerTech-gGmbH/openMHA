...
rem Indices of any disabled electrodes (0 = most apical, 21 = most basal):
...
rem Input sound file name (the file must have exactly 2 channels, and its 
rem sampling rate must correspond to the value of SRATE):
set IO_IN=soundfiles/vocoder_binaural_in.wav

rem Output sound file name:
set IO_OUT=vocoder_ace_binaural_out.wav
