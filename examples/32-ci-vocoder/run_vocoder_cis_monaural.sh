...
# Input sound file name (the file must have exactly 1 channel, and its 
# sampling rate must correspond to the value of SRATE):
export IO_IN=soundfiles/vocoder_monaural_in.wav

# Output sound file name:
export IO_OUT=vocoder_cis_monaural_out.wav


# Start the openMHA server and run the openMHA commands:
mha ?read:cfg/vocoder_cis_monaural.cfg cmd=start cmd=quit
